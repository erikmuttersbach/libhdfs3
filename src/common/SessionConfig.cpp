...
SessionConfig::SessionConfig(const Config & conf) {
    ...
    ConfigDefault<std::string> strValues [] = {
        ...
        {&namenodePrincipal, "dfs.namenode.kerberos.principal", "hdfs/localhost@HAWQ.PIVOTAL.COM" },
        {&datanodePrincipal, "dfs.datanode.kerberos.principal", "hdfs/_HOST@HAWQ.PIVOTAL.COM" }
    };
