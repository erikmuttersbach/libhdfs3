...
public:
    ...
    std::string getDatanodePrincipal() const {
        return datanodePrincipal;
    }

    void setDatanodePrincipal(std::string datanodePrincipal) {
        this->datanodePrincipal = datanodePrincipal;
    }

    std::string getNamenodePrincipal() const {
        return namenodePrincipal;
    }

    void setNamenodePrincipal(std::string namenodePrincipal) {
...
public:
    ...
    std::string namenodePrincipal;
    std::string datanodePrincipal;
